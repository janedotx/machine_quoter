...
class Shape
  ...
  # @param [String] the id of the vertex
  # @return [Array<Edge>]
  ...
  # @param [String] the id of the vertex
  # @param [String] the id of the edge
  # @return [Array<Edge>]
  ...
  # Create a hash where the keys are the ids and the values are Vertex instances.
  # Keys are strings.
  def get_vertices
    vertices = {}
  ...
  # Walk all the edges, marking them if they are circular and concave or convex.
  def process_edges
